 ...
 */
public class AppUserReq implements Serializable {
    ...
    public static AppUserDTO convertToDTO(AppUserReq req) {
        return req.convertToDTO();
    }

    public static List<AppUserDTO> convertToDTO(List<AppUserReq> reqs) {
